...
const Navbar = () => {
  return (
    <div>
      ...
      <img src="https://s3.ap-southeast-1.wasabisys.com/voltixsite/1698732835276_Voltixlogo.png?AWSAccessKeyId=MT0CVV2JO4QMMZ58V0PK&Expires=1698809906&Signature=D2Ja9WhDWOBTOUFf8WET%2BBL%2FOwY%3D" alt="VoltixLogo" className="logo" />
