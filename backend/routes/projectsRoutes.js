...
p_router.post("/projects/create", auth_1.verifyAccessToken, projectController.createProject);
p_router.put("/projects/update/:id", auth_1.verifyAccessToken, projectController.updateProject);
p_router.delete("/projects/delete/:id", auth_1.verifyAccessToken, projectController.deleteProject);
