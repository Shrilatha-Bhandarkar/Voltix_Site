...
s_router.post("/services", auth_1.verifyAccessToken, serviceController.createService);
s_router.put("/services", auth_1.verifyAccessToken, serviceController.updateService);
s_router.delete("/services", auth_1.verifyAccessToken, serviceController.deleteService);
