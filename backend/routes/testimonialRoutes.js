...
t_router.post("/testimonials", auth_1.verifyAccessToken, testimonialController.createTestimonial);
t_router.put("/testimonials", auth_1.verifyAccessToken, testimonialController.updateTestimonial);
t_router.delete("/testimonials", auth_1.verifyAccessToken, testimonialController.deleteTestimonial);
